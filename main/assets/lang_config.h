...
namespace Lang
{
    ...
    namespace Strings
    {
        ...
        constexpr const char *SHUTDOWN = "关机";
        constexpr const char *BOOT = "开机";
    }
    ...
    namespace Sounds
    {
        ...
        extern const char p3_boot_start[] asm("_binary_boot_p3_start");
        extern const char p3_boot_end[] asm("_binary_boot_p3_end");
        static const std::string_view P3_BOOT{
            static_cast<const char *>(p3_boot_start),
            static_cast<size_t>(p3_boot_end - p3_boot_start)};
        ...
        extern const char p3_shutdown_start[] asm("_binary_shutdown_p3_start");
        extern const char p3_shutdown_end[] asm("_binary_shutdown_p3_end");
        static const std::string_view P3_SHUTDOWN{
            static_cast<const char *>(p3_shutdown_start),
            static_cast<size_t>(p3_shutdown_end - p3_shutdown_start)};
