...
#define TAG "WEIWU_X1_LCD_ML307"

LV_FONT_DECLARE(font_puhui_20_4);
LV_FONT_DECLARE(font_awesome_20_4);

class WEIWU_X1_LCD_ML307 : public Ml307Board
{
private:
    Button boot_button_;
...
public:
    WEIWU_X1_LCD_ML307() : Ml307Board(ML307_TX_PIN, ML307_RX_PIN, 4096),
...
DECLARE_BOARD(WEIWU_X1_LCD_ML307);
